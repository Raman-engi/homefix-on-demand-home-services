...
const HowItWorks = () => {
  ...
  return (
    <section className="py-20 bg-[#fafafa] dark:bg-gray-950 transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {steps.map((step) => {
              ...
              return (
                ...
                >
                  <div className="w-16 h-16 rounded-full bg-white dark:bg-gray-800 border-4 border-gray-100 dark:border-gray-700 shadow-md flex items-center justify-center text-primary mb-6 relative z-10">
                    <Icon size={24} />
                  ...
                  <p className="text-gray-500 dark:text-gray-300 text-sm max-w-[200px]">
                    {step.description}
                  </p>
                </div>
              );
